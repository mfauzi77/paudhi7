...
const NationalRiskOverview = ({ regionalRiskScores, domain }) => {
    ...
    const sortedData = [...regionalRiskScores].sort((a, b) => b.score - a.score).slice(0, 10);
    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm h-full flex flex-col">
            <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-2 flex items-center">
                ...
                Top 10 High-Risk Provinces - {domain}
            </h3>
                    ...
                    return (
                        <div key={region.name} className="flex items-center group" title={`${region.name} - Skor Risiko: ${region.score}`}>
                            ...
                            <div className="w-3/5 sm:w-2/3 flex items-center">
                                <div className="w-full bg-slate-200 dark:bg-slate-600 rounded-full h-5 relative">
                                    <div 
            ...
            <div className="flex justify-end flex-wrap gap-x-2 gap-y-1 mt-4 text-xs text-slate-600 dark:text-slate-400">
