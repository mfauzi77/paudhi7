...
const KeyHealthIndicators = ({ indicators, domain }) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-4">Indikator Kunci - {domain}</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {indicators.length === 0 && <p className="text-slate-500 dark:text-slate-400 text-sm col-span-3">Tidak ada indikator kunci untuk domain ini.</p>}
            </div>
        </div>
    );
};
