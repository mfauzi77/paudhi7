...
const RegionalRiskTable = ({ data, onCreatePlan }) => {
    const [sortConfig, setSortConfig] = useState({ key: 'change', direction: 'descending' });
    ...
    const ThSortable = ({ sortKey, children, className }) => (
    ...
    return (
        <div>
            <h3 className="text-lg font-bold text-slate-800 mb-4">Proyeksi Risiko Detail per Wilayah</h3>
                ...
                <table className="w-full text-sm text-left text-slate-500">
                    <thead className="text-xs text-slate-700 uppercase bg-slate-100">
                        <tr>
                            ...
                            <ThSortable sortKey="predictedRisk" className="text-center">Proyeksi Risiko</ThSortable>
                             <th scope="col" className="px-2 sm:px-6 py-3 text-center">Level Risiko (Proyeksi)</th>
