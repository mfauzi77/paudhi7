...
import { ChartBarIcon, UsersIcon, BellAlertIcon } from '../icons/Icons';

const nationalAverageRisk = 65;

const RegionSummary = ({ data, alertsCount }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <StatCard 
                ...
                title="Alert Aktif"
                value={String(alertsCount ?? data.activeAlertsCount)}
