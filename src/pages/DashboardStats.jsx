...
const DashboardStats = ({ setActiveTab }) => {
  ...
  const [ranPaudLoading, setRanPaudLoading] = useState(true);
        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-3">
            <button 
              ...
              className="bg-white bg-opacity-20 hover:bg-opacity-30 px-4 py-2 rounded-lg transition-all flex items-center gap-2 mx-auto"
            >
      ...
      <div className="bg-gradient-to-r from-blue-500 to-emerald-500 rounded-lg p-6 text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <button 
            ...
            className="bg-white bg-opacity-20 hover:bg-opacity-30 px-4 py-3 rounded-lg transition-all flex items-center gap-2"
          >
